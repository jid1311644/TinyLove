...
public class OutlineContainer extends FrameLayout implements Animatable
{
	...
	private void init()
	{
		...
		mOutlinePaint.setColor(getResources().getColor(R.color.themeColor));
	...
	protected void dispatchDraw(Canvas canvas)
	{
		...
		if (mOutlinePaint.getColor() != PictureView.sOutlineColor)
		{
			mOutlinePaint.setColor(PictureView.sOutlineColor);
		}
